...
$q = "UPDATE t_registrasi SET followup_status=".mysqli_real_escape_string($dblink,$statusid).",approvereject_status=0 WHERE uid='".mysqli_real_escape_string($dblink,$id)."'";
